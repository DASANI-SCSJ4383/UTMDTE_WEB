...
`,u="	",s=" ",t="~",o="`",c=3,a=4;function D(i,l,d){var h=this,g=h.options.gfm,F=l.length+1,C=0,x="",p,b,f,v,m,E,B,q,L,w,O,T,P;if(!!g){for(;C<F&&(f=l.charAt(C),!(f!==s&&f!==u));)x+=f,C++;if(T=C,f=l.charAt(C),!(f!==t&&f!==o)){for(C++,b=f,p=1,x+=f;C<F&&(f=l.charAt(C),f===b);)x+=f,p++,C++;if(!(p<c)){for(;C<F&&(f=l.charAt(C),!(f!==s&&f!==u));)x+=f,C++;for(v="",B="";C<F&&(f=l.charAt(C),!(f===e||b===o&&f===b));)f===s||f===u?B+=f:(v+=B+f,B=""),C++;if(f=l.charAt(C),!(f&&f!==e)){if(d)return!0;P=i.now(),P.column+=x.length,P.offset+=x.length,x+=v,v=h.decode.raw(h.unescape(v),P),B&&(x+=B),B="",w="",O="",q="",L="";for(var A=!0;C<F;){if(f=l.charAt(C),q+=w,L+=O,w="",O="",f!==e){q+=f,O+=f,C++;continue}for(A?(x+=f,A=!1):(w+=f,O+=f),B="",C++;C<F&&(f=l.charAt(C),f===s);)B+=f,C++;if(w+=B,O+=B.slice(T),!(B.length>=a)){for(B="";C<F&&(f=l.charAt(C),f===b);)B+=f,C++;if(w+=B,O+=B,!(B.length<p)){for(B="";C<F&&(f=l.charAt(C),!(f!==s&&f!==u));)w+=f,O+=f,C++;if(!f||f===e)break}}}for(x+=q+w,C=-1,F=v.length;++C<F;)if(f=v.charAt(C),f===s||f===u)m||(m=v.slice(0,C));else if(m){E=v.slice(C);break}return i(x)({type:"code",lang:m||v||null,meta:E||null,value:L})}}}}}}}),ze=I({"node_modules/trim/index.js"(n,r){S(),n=r.exports=e;function e(u){return u.replace(/^\s*|\s*$/g,"")}n.left=function(u){return u.replace(/^\s*/,"")},n.right=function(u){return u.replace(/\s*$/,"")}}}),fu=I({"node_modules/remark-parse/lib/util/interrupt.js"(n,r){"use strict";S(),r.exports=e;function e(u,s,t,o){for(var c=u.length,a=-1,D,i;++a<c;)if(D=u[a],i=D[1]||{},!(i.pedantic!==void 0&&i.pedantic!==t.options.pedantic)&&!(i.commonmark!==void 0&&i.commonmark!==t.options.commonmark)&&s[D[0]].apply(t,o))return!0;return!1}}}),Kl=I({"node_modules/remark-parse/lib/tokenize/blockquote.js"(n,r){"use strict";S();var e=ze(),u=fu();r.exports=a;var s=`
`,t="	",o=" ",c=">";function a(D,i,l){for(var d=this,h=d.offset,g=d.blockTokenizers,F=d.interruptBlockquote,C=D.now(),x=C.line,p=i.length,b=[],f=[],v=[],m,E=0,B,q,L,w,O,T,P,A;E<p&&(B=i.charAt(E),!(B!==o&&B!==t));)E++;if(i.charAt(E)===c){if(l)return!0;for(E=0;E<p;){for(L=i.indexOf(s,E),T=E,P=!1,L===-1&&(L=p);E<p&&(B=i.charAt(E),!(B!==o&&B!==t));)E++;if(i.charAt(E)===c?(E++,P=!0,i.charAt(E)===o&&E++):E=T,w=i.slice(E,L),!P&&!e(w)){E=T;break}if(!P&&(q=i.slice(E),u(F,g,d,[D,q,!0])))break;O=T===E?w:i.slice(T,L),v.push(E-T),b.push(O),f.push(w),E=L+1}for(E=-1,p=v.length,m=D(b.join(s));++E<p;)h[x]=(h[x]||0)+v[E],x++;return A=d.enterBlock(),f=d.tokenizeBlock(f.join(s),C),A(),m({type:"blockquote",children:f})}}}}),Yl=I({"node_modules/remark-parse/lib/tokenize/heading-atx.js"(n,r){"use strict";S(),r.exports=c;var e=`
